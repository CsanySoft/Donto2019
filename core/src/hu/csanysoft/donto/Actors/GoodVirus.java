...
public class GoodVirus extends Virus {
    ...
    public GoodVirus() {
        ...
        addSprite(body);
        setPosition(Globals.random.nextInt(Globals.WORLD_WIDTH / 2 - (int)getWidth()) + Globals.WORLD_WIDTH / 2 + Globals.random.nextFloat(), Globals.random.nextInt(Globals.WORLD_HEIGHT - (int)getHeight()) + Globals.random.nextFloat());
    }
}
